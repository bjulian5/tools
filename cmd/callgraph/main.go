...
package main // import "github.com/bjulian5/tools/cmd/callgraph"
...
import (
	...
	"github.com/bjulian5/tools/go/callgraph"
	"github.com/bjulian5/tools/go/callgraph/cha"
	"github.com/bjulian5/tools/go/callgraph/rta"
	"github.com/bjulian5/tools/go/callgraph/static"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/bjulian5/tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/bjulian5/tools/cmd/callgraph |
      digraph succs github.com/bjulian5/tools/cmd/callgraph.main
`
