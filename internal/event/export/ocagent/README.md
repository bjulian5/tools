...
1. Clone the [tools](https://github.com/bjulian5/tools) subrepository.
...
import (
	...
	"github.com/bjulian5/tools/internal/event/export/metric"
	"github.com/bjulian5/tools/internal/event/export/ocagent"
)
