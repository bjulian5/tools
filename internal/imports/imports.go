...
// Options is github.com/bjulian5/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/bjulian5/tools/imports.Process with explicit context in opt.Env.
