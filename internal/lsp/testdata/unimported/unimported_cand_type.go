...
import (
	...
	"github.com/bjulian5/tools/internal/lsp/baz"
	_ "github.com/bjulian5/tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)
